...
print('[+] Energized Ultimate and Formats - Building...')
Sources = [
...
with open(File, 'w') as f:
	...
	f.write('''# -------------------------------------------\n# P A C K  D E T A I L S\n# -------------------------------------------\n# Package: Energized Ultimate Protection\n# Format: hosts\n# Version: ''' + time.strftime("%y.%m.%j", time.gmtime()) + '''\n# Release: ''' + time.strftime("%j", time.gmtime()) + '''\n# Entries: {}'''.format(str(len(List))) + '''\n# Pack Code: EUL71M473-P\n# License: CC BY-NC-SA 4.0, https://nayemador.com/energized/license\n# Updated: {}'''.format(datetime.datetime.now().strftime('%a, %d %b %y %X')))
	f.write('''\n# RAW: https://raw.githubusercontent.com/EnergizedProtection/block/master/ultimate/formats/hosts\n# Mirror: https://nayemador.com/energized/ultimate\n# -------------------------------------------\n\n''')
...
with open(Hostsv6, 'w') as f:
	...
	f.write('''#    _____  _________  _____________  _______\n#   / __/ |/ / __/ _ \/ ___/  _/_  / / __/ _ \ \n#  / _// ,  / _// , _/ (_ // /  / /_/ _// // /\n# /___/_/|_/___/_/|_|\___/___/ /___/___/____/\n#\n#    P   R   O   T   E   C   T   I   O   N\n# -------------------------------------------\n#          ad.porn.malware blocking.\n#                   ------\n#      Merged collection of hosts from\n#             reputable sources.\n# -------------------------------------------\n#          nayemador.com/energized/\n#    github.com/EnergizedProtection/block\n# -------------------------------------------\n\n#        Let's make an annoyance free\n#      better open internet. Altogether.\n#                  ------\n\n''')
	f.write('''# -------------------------------------------\n# P A C K  D E T A I L S\n# -------------------------------------------\n# Package: Energized Ultimate Protection\n# Format: hosts ipv6\n# Version: ''' + time.strftime("%y.%m.%j", time.gmtime()) + '''\n# Release: ''' + time.strftime("%j", time.gmtime()) + '''\n# Entries: {}'''.format(str(len(List))) + '''\n# Pack Code: EUL71M473-P\n# License: CC BY-NC-SA 4.0, https://nayemador.com/energized/license\n# Updated: {}'''.format(datetime.datetime.now().strftime('%a, %d %b %y %X')))
	f.write('''\n# RAW: https://raw.githubusercontent.com/EnergizedProtection/block/master/ultimate/formats/hosts-ipv6.txt\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# L O C A L  H O S T\n# -------------------------------------------\n127.0.0.1 localhost\n127.0.0.1 localhost.localdomain\n127.0.0.1 local\n255.255.255.255 broadcasthost\n::1 localhost\n::1 ip6-localhost\n::1 ip6-loopback\nfe80::1%lo0 localhost\nff00::0 ip6-localnet\nff00::0 ip6-mcastprefix\nff02::1 ip6-allnodes\nff02::2 ip6-allrouters\nff02::3 ip6-allhosts\n0.0.0.0 0.0.0.0\n# -------------------------------------------\n''')
	f.write('''\n# -------------------------------------------\n# F E A T U R E S\n# -------------------------------------------\n# _hosts based: based on Hosts file.\n# _any device: compatible with all devices.\n# _blockings: strictly blocks web annoyances.\n# _formats: most used formats.\n# _speed: reduces page loading time.\n# _privacy: increases privacy.\n# _saves expense: decreases data consumption.\n# _clean: no extra abracadabra!\n# -------------------------------------------\n''')
	f.write('''\n# -------------------------------------------\n# T E A M  B O L T Z - meet the team\n# -------------------------------------------\n# @AdroitAdorKhan - Head Developer & Maintainer\n# @AvinashReddy3108 - Developer\n# @badmojr - Maintainer\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# E N E R G I Z E D  B E G I N S\n# -------------------------------------------\n\n''')
...
with open(Text, 'w') as f:
	...
	f.write('''#    _____  _________  _____________  _______\n#   / __/ |/ / __/ _ \/ ___/  _/_  / / __/ _ \ \n#  / _// ,  / _// , _/ (_ // /  / /_/ _// // /\n# /___/_/|_/___/_/|_|\___/___/ /___/___/____/\n#\n#    P   R   O   T   E   C   T   I   O   N\n# -------------------------------------------\n#          ad.porn.malware blocking.\n#                   ------\n#      Merged collection of hosts from\n#             reputable sources.\n# -------------------------------------------\n#          nayemador.com/energized/\n#    github.com/EnergizedProtection/block\n# -------------------------------------------\n\n#        Let's make an annoyance free\n#      better open internet. Altogether.\n#                  ------\n\n''')
	f.write('''# -------------------------------------------\n# P A C K  D E T A I L S\n# -------------------------------------------\n# Package: Energized Ultimate Protection\n# Format: hosts\n# Version: ''' + time.strftime("%y.%m.%j", time.gmtime()) + '''\n# Release: ''' + time.strftime("%j", time.gmtime()) + '''\n# Entries: {}'''.format(str(len(List))) + '''\n# Pack Code: EUL71M473-P\n# License: CC BY-NC-SA 4.0, https://nayemador.com/energized/license\n# Updated: {}'''.format(datetime.datetime.now().strftime('%a, %d %b %y %X')))
	f.write('''\n# RAW: https://raw.githubusercontent.com/EnergizedProtection/block/master/ultimate/formats/hosts.txt\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# L O C A L  H O S T\n# -------------------------------------------\n127.0.0.1 localhost\n127.0.0.1 localhost.localdomain\n127.0.0.1 local\n255.255.255.255 broadcasthost\n::1 localhost\n::1 ip6-localhost\n::1 ip6-loopback\nfe80::1%lo0 localhost\nff00::0 ip6-localnet\nff00::0 ip6-mcastprefix\nff02::1 ip6-allnodes\nff02::2 ip6-allrouters\nff02::3 ip6-allhosts\n0.0.0.0 0.0.0.0\n# -------------------------------------------\n''')
	f.write('''\n# -------------------------------------------\n# F E A T U R E S\n# -------------------------------------------\n# _hosts based: based on Hosts file.\n# _any device: compatible with all devices.\n# _blockings: strictly blocks web annoyances.\n# _formats: most used formats.\n# _speed: reduces page loading time.\n# _privacy: increases privacy.\n# _saves expense: decreases data consumption.\n# _clean: no extra abracadabra!\n# -------------------------------------------\n''')
	f.write('''\n# -------------------------------------------\n# T E A M  B O L T Z - meet the team\n# -------------------------------------------\n# @AdroitAdorKhan - Head Developer & Maintainer\n# @AvinashReddy3108 - Developer\n# @badmojr - Maintainer\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# E N E R G I Z E D  B E G I N S\n# -------------------------------------------\n\n''')
...
with open(Filter, 'w') as f:
	...
	f.write('''\n! RAW: https://raw.githubusercontent.com/EnergizedProtection/block/master/ultimate/formats/filter\n! -------------------------------------------\n\n''')
	f.write('''! -------------------------------------------\n! F E A T U R E S\n! -------------------------------------------\n! _hosts based: based on Hosts file.\n! _any device: compatible with all devices.\n! _blockings: strictly blocks web annoyances.\n! _formats: most used formats.\n! _speed: reduces page loading time.\n! _privacy: increases privacy.\n! _saves expense: decreases data consumption.\n! _clean: no extra abracadabra!\n! -------------------------------------------\n''')
	f.write('''\n! -------------------------------------------\n! T E A M  B O L T Z - meet the team\n! -------------------------------------------\n! @AdroitAdorKhan - Head Developer & Maintainer\n! @AvinashReddy3108 - Developer\n! @badmojr - Maintainer\n! -------------------------------------------\n\n''')
	f.write('''! -------------------------------------------\n! E N E R G I Z E D  B E G I N S\n! -------------------------------------------\n\n''')
	f.write('\n'.join('||' + url for url in List))
...
with open(Domains, 'w') as f:
	...
	f.write('''#    _____  _________  _____________  _______\n#   / __/ |/ / __/ _ \/ ___/  _/_  / / __/ _ \ \n#  / _// ,  / _// , _/ (_ // /  / /_/ _// // /\n# /___/_/|_/___/_/|_|\___/___/ /___/___/____/\n#\n#    P   R   O   T   E   C   T   I   O   N\n# -------------------------------------------\n#          ad.porn.malware blocking.\n#                   ------\n#      Merged collection of hosts from\n#             reputable sources.\n# -------------------------------------------\n#          nayemador.com/energized/\n#    github.com/EnergizedProtection/block\n# -------------------------------------------\n\n#        Let's make an annoyance free\n#      better open internet. Altogether.\n#                  ------\n\n''')
	f.write('''# -------------------------------------------\n# P A C K  D E T A I L S\n# -------------------------------------------\n# Package: Energized Ultimate Protection\n# Format: domain list\n# Version: ''' + time.strftime("%y.%m.%j", time.gmtime()) + '''\n# Release: ''' + time.strftime("%j", time.gmtime()) + '''\n# Entries: {}'''.format(str(len(List))) + '''\n# Pack Code: EUL71M473-P\n# License: CC BY-NC-SA 4.0, https://nayemador.com/energized/license\n# Updated: {}'''.format(datetime.datetime.now().strftime('%a, %d %b %y %X')))
	f.write('''\n# RAW: https://raw.githubusercontent.com/EnergizedProtection/block/master/ultimate/formats/domains.txt\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# F E A T U R E S\n# -------------------------------------------\n# _hosts based: based on Hosts file.\n# _any device: compatible with all devices.\n# _blockings: strictly blocks web annoyances.\n# _formats: most used formats.\n# _speed: reduces page loading time.\n# _privacy: increases privacy.\n# _saves expense: decreases data consumption.\n# _clean: no extra abracadabra!\n# -------------------------------------------\n''')
	f.write('''\n# -------------------------------------------\n# T E A M  B O L T Z - meet the team\n# -------------------------------------------\n# @AdroitAdorKhan - Head Developer & Maintainer\n# @AvinashReddy3108 - Developer\n# @badmojr - Maintainer\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# E N E R G I Z E D  B E G I N S\n# -------------------------------------------\n\n''')
	f.write('\n'.join(url for url in List))
...
with open(Masq, 'w') as f:
	...
	f.write('''#    _____  _________  _____________  _______\n#   / __/ |/ / __/ _ \/ ___/  _/_  / / __/ _ \ \n#  / _// ,  / _// , _/ (_ // /  / /_/ _// // /\n# /___/_/|_/___/_/|_|\___/___/ /___/___/____/\n#\n#    P   R   O   T   E   C   T   I   O   N\n# -------------------------------------------\n#          ad.porn.malware blocking.\n#                   ------\n#      Merged collection of hosts from\n#             reputable sources.\n# -------------------------------------------\n#          nayemador.com/energized/\n#    github.com/EnergizedProtection/block\n# -------------------------------------------\n\n#        Let's make an annoyance free\n#      better open internet. Altogether.\n#                  ------\n\n''')
	f.write('''# -------------------------------------------\n# P A C K  D E T A I L S\n# -------------------------------------------\n# Package: Energized Ultimate Protection\n# Format: dnsmasq\n# Version: ''' + time.strftime("%y.%m.%j", time.gmtime()) + '''\n# Release: ''' + time.strftime("%j", time.gmtime()) + '''\n# Entries: {}'''.format(str(len(List))) + '''\n# Pack Code: EUL71M473-P\n# License: CC BY-NC-SA 4.0, https://nayemador.com/energized/license\n# Updated: {}'''.format(datetime.datetime.now().strftime('%a, %d %b %y %X')))
	f.write('''\n# RAW: https://raw.githubusercontent.com/EnergizedProtection/block/master/ultimate/formats/dnsmasq.conf\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# F E A T U R E S\n# -------------------------------------------\n# _hosts based: based on Hosts file.\n# _any device: compatible with all devices.\n# _blockings: strictly blocks web annoyances.\n# _formats: most used formats.\n# _speed: reduces page loading time.\n# _privacy: increases privacy.\n# _saves expense: decreases data consumption.\n# _clean: no extra abracadabra!\n# -------------------------------------------\n''')
	f.write('''\n# -------------------------------------------\n# T E A M  B O L T Z - meet the team\n# -------------------------------------------\n# @AdroitAdorKhan - Head Developer & Maintainer\n# @AvinashReddy3108 - Developer\n# @badmojr - Maintainer\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# E N E R G I Z E D  B E G I N S\n# -------------------------------------------\n\n''')
...
with open(Ipv6, 'w') as f:
	...
	f.write('''#    _____  _________  _____________  _______\n#   / __/ |/ / __/ _ \/ ___/  _/_  / / __/ _ \ \n#  / _// ,  / _// , _/ (_ // /  / /_/ _// // /\n# /___/_/|_/___/_/|_|\___/___/ /___/___/____/\n#\n#    P   R   O   T   E   C   T   I   O   N\n# -------------------------------------------\n#          ad.porn.malware blocking.\n#                   ------\n#      Merged collection of hosts from\n#             reputable sources.\n# -------------------------------------------\n#          nayemador.com/energized/\n#    github.com/EnergizedProtection/block\n# -------------------------------------------\n\n#        Let's make an annoyance free\n#      better open internet. Altogether.\n#                  ------\n\n''')
	f.write('''# -------------------------------------------\n# P A C K  D E T A I L S\n# -------------------------------------------\n# Package: Energized Ultimate Protection\n# Format: dnsmasq ipv6\n# Version: ''' + time.strftime("%y.%m.%j", time.gmtime()) + '''\n# Release: ''' + time.strftime("%j", time.gmtime()) + '''\n# Entries: {}'''.format(str(len(List))) + '''\n# Pack Code: EUL71M473-P\n# License: CC BY-NC-SA 4.0, https://nayemador.com/energized/license\n# Updated: {}'''.format(datetime.datetime.now().strftime('%a, %d %b %y %X')))
	f.write('''\n# RAW: https://raw.githubusercontent.com/EnergizedProtection/block/master/ultimate/formats/dnsmasq-ipv6.conf\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# F E A T U R E S\n# -------------------------------------------\n# _hosts based: based on Hosts file.\n# _any device: compatible with all devices.\n# _blockings: strictly blocks web annoyances.\n# _formats: most used formats.\n# _speed: reduces page loading time.\n# _privacy: increases privacy.\n# _saves expense: decreases data consumption.\n# _clean: no extra abracadabra!\n# -------------------------------------------\n''')
	f.write('''\n# -------------------------------------------\n# T E A M  B O L T Z - meet the team\n# -------------------------------------------\n# @AdroitAdorKhan - Head Developer & Maintainer\n# @AvinashReddy3108 - Developer\n# @badmojr - Maintainer\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# E N E R G I Z E D  B E G I N S\n# -------------------------------------------\n\n''')
...
with open(Unbound, 'w') as f:
	...
	f.write('''#    _____  _________  _____________  _______\n#   / __/ |/ / __/ _ \/ ___/  _/_  / / __/ _ \ \n#  / _// ,  / _// , _/ (_ // /  / /_/ _// // /\n# /___/_/|_/___/_/|_|\___/___/ /___/___/____/\n#\n#    P   R   O   T   E   C   T   I   O   N\n# -------------------------------------------\n#          ad.porn.malware blocking.\n#                   ------\n#      Merged collection of hosts from\n#             reputable sources.\n# -------------------------------------------\n#          nayemador.com/energized/\n#    github.com/EnergizedProtection/block\n# -------------------------------------------\n\n#        Let's make an annoyance free\n#      better open internet. Altogether.\n#                  ------\n\n''')
	f.write('''# -------------------------------------------\n# P A C K  D E T A I L S\n# -------------------------------------------\n# Package: Energized Ultimate Protection\n# Format: unbound\n# Version: ''' + time.strftime("%y.%m.%j", time.gmtime()) + '''\n# Release: ''' + time.strftime("%j", time.gmtime()) + '''\n# Entries: {}'''.format(str(len(List))) + '''\n# Pack Code: EUL71M473-P\n# License: CC BY-NC-SA 4.0, https://nayemador.com/energized/license\n# Updated: {}'''.format(datetime.datetime.now().strftime('%a, %d %b %y %X')))
	f.write('''\n# RAW: https://raw.githubusercontent.com/EnergizedProtection/block/master/ultimate/formats/unbound.conf\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# F E A T U R E S\n# -------------------------------------------\n# _hosts based: based on Hosts file.\n# _any device: compatible with all devices.\n# _blockings: strictly blocks web annoyances.\n# _formats: most used formats.\n# _speed: reduces page loading time.\n# _privacy: increases privacy.\n# _saves expense: decreases data consumption.\n# _clean: no extra abracadabra!\n# -------------------------------------------\n''')
	f.write('''\n# -------------------------------------------\n# T E A M  B O L T Z - meet the team\n# -------------------------------------------\n# @AdroitAdorKhan - Head Developer & Maintainer\n# @AvinashReddy3108 - Developer\n# @badmojr - Maintainer\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# E N E R G I Z E D  B E G I N S\n# -------------------------------------------\n\n''')
...
with open(Rpz, 'w') as f:
	...
	f.write('''#    _____  _________  _____________  _______\n#   / __/ |/ / __/ _ \/ ___/  _/_  / / __/ _ \ \n#  / _// ,  / _// , _/ (_ // /  / /_/ _// // /\n# /___/_/|_/___/_/|_|\___/___/ /___/___/____/\n#\n#    P   R   O   T   E   C   T   I   O   N\n# -------------------------------------------\n#          ad.porn.malware blocking.\n#                   ------\n#      Merged collection of hosts from\n#             reputable sources.\n# -------------------------------------------\n#          nayemador.com/energized/\n#    github.com/EnergizedProtection/block\n# -------------------------------------------\n\n#        Let's make an annoyance free\n#      better open internet. Altogether.\n#                  ------\n\n''')
	f.write('''# -------------------------------------------\n# P A C K  D E T A I L S\n# -------------------------------------------\n# Package: Energized Ultimate Protection\n# Format: rpz\n# Version: ''' + time.strftime("%y.%m.%j", time.gmtime()) + '''\n# Release: ''' + time.strftime("%j", time.gmtime()) + '''\n# Entries: {}'''.format(str(len(List))) + '''\n# Pack Code: EUL71M473-P\n# License: CC BY-NC-SA 4.0, https://nayemador.com/energized/license\n# Updated: {}'''.format(datetime.datetime.now().strftime('%a, %d %b %y %X')))
	f.write('''\n# RAW: https://raw.githubusercontent.com/EnergizedProtection/block/master/ultimate/formats/rpz.txt\n# -------------------------------------------\n\n''')
	f.write('''# -------------------------------------------\n# F E A T U R E S\n# -------------------------------------------\n# _hosts based: based on Hosts file.\n# _any device: compatible with all devices.\n# _blockings: strictly blocks web annoyances.\n# _formats: most used formats.\n# _speed: reduces page loading time.\n# _privacy: increases privacy.\n# _saves expense: decreases data consumption.\n# _clean: no extra abracadabra!\n# -------------------------------------------\n\n''')
