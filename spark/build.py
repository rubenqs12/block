...
print('[+] Energized Spark - Building...')
Sources = [
    ...
    'https://raw.githubusercontent.com/EnergizedProtection/mirror/master/active/filter/sbc-hosts.txt',
...
with open(File, 'w') as f:
	...
	f.write('''\n# RAW: https://raw.githubusercontent.com/EnergizedProtection/block/master/spark/formats/hosts\n# Mirror: https://nayemador.com/energized/spark\n# -------------------------------------------\n\n''')
