...
unf=../../unified/formats
sext=../../extensions/formats
pext=../../extensions/formats
...
# Extensions Count
socialext=$(egrep 'Entries: ' $sext/ext-social-hosts)
pornext=$(egrep 'Entries: ' $pext/ext-porn-hosts)
# RAW & TXT Size
